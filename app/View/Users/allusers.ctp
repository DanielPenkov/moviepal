...
<?php foreach ($users as $user): ?>
  ...
  <div class="col-sm-4 col-md-3">
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3><?php echo $user['users']['username']; ?></h3>
        <p><?php echo $user['users']['email']; ?></p>
        <p><a href="#" class="btn btn-primary" role="button">View profile</a>


         <a onclick="addFriend(<?php echo $user['users']['id']; ?>)" "href="javascript:void(0);" class="btn btn-default" >Add to Friends</a></p>
